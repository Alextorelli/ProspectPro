...
const requiredSecrets = [
  ...
  {
    name: 'GCP_REGION',
    description: 'Google Cloud region for deployment (optional, defaults to us-central1)',
    example: 'us-central1'
  },
  {
    name: 'SUPABASE_URL',
...
console.log('• Make sure the service account has required Cloud Run permissions');
...
console.log('');
console.log('git add . && git commit -m "fix: Configure GitHub secrets for Cloud Run deployment" && git push');
console.log('');
