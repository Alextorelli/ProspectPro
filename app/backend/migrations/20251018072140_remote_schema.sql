...
drop function if exists "public"."store_cached_response"(p_request_type text, p_params jsonb, p_response jsonb, p_cost numeric, p_confidence_score integer, p_ttl interval);
