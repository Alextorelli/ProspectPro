...
mkdir -p dev-tools/workspace/context/session_store/deployments
REPORT_FILE="dev-tools/workspace/context/session_store/deployments/vercel-status-$(date +%Y%m%d-%H%M%S).json"
