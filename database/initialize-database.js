...
class DatabaseInitializer {
  constructor() {
    ...
    this.supabaseKey = process.env.SUPABASE_SERVICE_ROLE_KEY || process.env.SUPABASE_SECRET_KEY;
    this.client = null;
  ...
  async validateCredentials() {
    ...
    if (!this.supabaseKey) {
      throw new Error('SUPABASE_SERVICE_ROLE_KEY or SUPABASE_SECRET_KEY is required in environment variables');
    }
