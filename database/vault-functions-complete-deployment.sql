-- =====================================================
-- ProspectPro Vault Functions - Complete Deployment
-- =====================================================
-- Deploy all vault functions with security hardening
-- Idempotent: Safe to run multiple times
-- Execute in Supabase SQL Editor

-- =====================================================
-- Function 1: vault_decrypt_secret
-- =====================================================
...
-- =====================================================
-- Function 2: vault_decrypt_multiple_secrets
-- =====================================================
...
-- =====================================================
-- Function 3: vault_diagnostic_check
-- =====================================================
...
-- =====================================================
-- Run this after deployment to verify all functions are working

SELECT 
    'vault_decrypt_secret' as function_name,
    proname as deployed_name,
    pg_get_function_arguments(oid) as arguments,
    prosecdef as security_definer
FROM pg_proc 
WHERE proname = 'vault_decrypt_secret'

UNION ALL

SELECT 
    'vault_decrypt_multiple_secrets' as function_name,
    proname as deployed_name,
    pg_get_function_arguments(oid) as arguments,
    prosecdef as security_definer
FROM pg_proc 
WHERE proname = 'vault_decrypt_multiple_secrets'

UNION ALL

SELECT 
    'vault_diagnostic_check' as function_name,
    proname as deployed_name,
    pg_get_function_arguments(oid) as arguments,
    prosecdef as security_definer
FROM pg_proc 
WHERE proname = 'vault_diagnostic_check';