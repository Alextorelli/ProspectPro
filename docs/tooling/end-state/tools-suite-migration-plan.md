...
| dev-tools/context/_, scripts/context/_         | Context collectors output to legacy folders                              | **Refactor**: add participant flag, route snapshots to `dev-tools/context/session_store/<tag>/` per workspace migration guide |
...
| dev-tools/context/session_store/history/\*                     | Round 1 assets mixed with current                                        | **Remove/Archive** redundant Round 1 outputs into round-1                                                     |
...
2. **Agent Orchestration & Context Scripts**
   ...
   - Route context snapshots to `dev-tools/context/session_store/<tag>/`.
...
- Log results in `dev-tools/context/session_store/coverage.md` and `settings-troubleshooting.md`
...
1. Validate staged MCP config/registry via `npm run mcp:chat:validate` and record outputs in `settings-troubleshooting.md` & `dev-tools/context/session_store/coverage.md`.
...
5. Log changes in `docs/tooling/settings-troubleshooting.md` and `dev-tools/context/session_store/coverage.md`, archive remaining Round 1 assets, and proceed to CI updates.
